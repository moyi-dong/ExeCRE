...
class ChatOpenAI(EngineLM, CachedEngine):
    ...
    def _should_use_max_completion_tokens(self):
        """Check if the current model requires max_completion_tokens instead of max_tokens."""
        return self.model_string in MODELS_REQUIRING_MAX_COMPLETION_TOKENS
    ...
    def _generate_from_single_prompt(
        ...
        # Prepare API parameters based on model requirements
        api_params = {
        ...
        # Use max_completion_tokens for new models, max_tokens for default
