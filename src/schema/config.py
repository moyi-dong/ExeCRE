class SchemaConfig:
    """Runtime schema and generator config."""
    
    def __init__(self, **kwargs):
        self.default_range_limits = kwargs.get('default_range_limits', {
            'list': (1, 20),
            'matrix': (1, 20),
            'group': (1, 20),
        })

        self.variable_default_limits = kwargs.get('variable_default_limits', {
            'int': (-20, 20),
            'float': (-20.0, 20.0),
            'char': None,
            'string': None,
        ...
        self.default_separators = kwargs.get('default_separators', {
            'list': " ",
            'group': "\\n",
            'row_split': "\\n",
            'column_split': " ",
